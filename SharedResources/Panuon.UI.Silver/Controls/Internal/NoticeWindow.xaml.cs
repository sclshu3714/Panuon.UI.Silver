...
namespace Panuon.UI.Silver.Controls.Internal
{
    ...
    internal partial class NoticeWindow : Window
    {
        ...
        {
            InitializeComponent();
            this.Loaded += NoticeWindow_Loaded;
            Instance = this;
        }
        ...
        private void NoticeWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            AicWindowStyles exStyle = (AicWindowStyles)GetWindowLong(windowInterop.Handle, GWL_EXSTYLE);
            exStyle |= AicWindowStyles.WS_EX_TOOLWINDOW;
            SetWindowLong(windowInterop.Handle, GWL_EXSTYLE, new IntPtr((long)exStyle));
        }
    ...
    [Flags]
    public enum AicWindowStyles : long
    {
        /// <summary>
