...
{
    public class MsbButtonVisibilityConverter : IValueConverter
    {
    ...
    public class MsbButtonIsDefaultConverter : IMultiValueConverter
    {
    ...
    public class MsbCheckIconVisibilityConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
    ...
    public class MsbCheckIconWidthConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            var icon = (MessageBoxIcon)Enum.Parse(typeof(MessageBoxIcon), value.ToString());
