...
{
    public class TabControlSideButtonVisibilityConverter : IMultiValueConverter
    {
    ...
    public class TabControlRemoveButtonPaddingConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
    ...
    public class TabControlScrollViewerMaxWidthConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
